...
const oneSwiper = new Swiper('.slider-territory__swiper', {
  slidePerView: 1,
  loop: true,
  speed: 700,
  simulateTouch: false,
  navigation: {
    nextEl: '.territory__button-next',
    prevEl: '.territory__button-prev',
  }
})
/* //////////////////////////////////////////////////////////////////////////////// */
const twoSwiper = new Swiper('.slider-car__swiper', {
  slidePerView: 1,
  loop: true,
  speed: 700,
  simulateTouch: false,
  navigation: {
    nextEl: '.car-navigation__next',
    prevEl: '.car-navigation__prev',
  }
})
/* //////////////////////////////////////////////////////////////////////////////// */
const threeSwiper = new Swiper('.slider-design__swiper', {
  loop: true,
  slidePerView: 1,
  speed: 700,
  simulateTouch: false,
  navigation: {
    nextEl: '.animation-block-design__button-next',
    prevEl: '.animation-block-design__button-prev',
  }
})
/* //////////////////////////////////////////////////////////////////////////////// */
const FooSwiper = new Swiper('.bergen-swiper', {
  loop: true,
  slidePerView: 1,
  speed: 700,
  simulateTouch: false,
  navigation: {
    nextEl: '.bergen-nutton-next',
    prevEl: '.bergen-nutton-prev',
  }
})
/* //////////////////////////////////////////////////////////////////////////////// */
const fiveSlider = new Swiper('.new-york-slider', {
  loop: true,
  slidePerView: 1,
  speed: 700,
  simulateTouch: false,
  navigation: {
    nextEl: '.new-york-next',
    prevEl: '.new-york-prev',
  }
})
/* //////////////////////////////////////////////////////////////////////////////// */
const sictSwiper = new Swiper('.body-house-choice__swiper', {
  loop: true,
  slidePerView: 1,
  speed: 700,
  simulateTouch: false,
  navigation: {
    nextEl: '.body-house-choice__button-next',
    prevEl: '.body-house-choice__button-prev',
  }
})
/* //////////////////////////////////////////////////////////////////////////////// */
/* //////////////////////////////////////////////////////////////////////////////// */
...
/* map */
function init() {
  let map = new ymaps.Map('map-center', {
    center: [55.589784727030434, 37.10018963887226],
    zoom: 16
  });
